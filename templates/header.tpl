<html>
    <head>
        ...
        <link href="{$templateRoot}libs/bootstrap/css/bootstrap.min.css" rel="stylesheet">
        ...
        <link href="{$templateRoot}css/styles.css" type="text/css" rel="stylesheet">
        <script src="{$templateRoot}libs/bootstrap/js/jquery.min.js"></script>
        <script src="{$templateRoot}libs/bootstrap/js/bootstrap.min.js"></script>
