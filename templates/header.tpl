<html>
    <head>
        ...
        <link href="../libs/bootstrapvalidator-dist-0.5.3/dist/css/bootstrapValidator.min.css" rel="stylesheet">
        ...
        <script src="../libs/bootstrapvalidator-dist-0.5.3/src/js/language/pt_BR.js" type="text/javascript"></script>
        <script type="text/javascript" src="../libs/alertify.js-0.3.11/lib/alertify.min.js"></script>
    </head>